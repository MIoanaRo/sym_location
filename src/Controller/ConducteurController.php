...
class ConducteurController extends AbstractController
{
     ...
     */
    public function index(ConducteurRepository $conducteurRepository, Request $request )
    {
        $results = null;
        $conducteurSearch = $request->request->get('conducteur_search');

        if($conducteurSearch){
            $results = $conducteurRepository-> findByFirstNameAndLastName($conducteurSearch);
        }
        else{
            $results = $conducteurRepository->findAll();
        }
