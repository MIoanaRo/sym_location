...
class VehiculeController extends AbstractController
{
     ...
     */
    public function index(VehiculeRepository $vehiculeRepository, Request $request)
    {
        $results = null;
        $vehiculeSearch = $request->request->get('vehicule_search');

        if($vehiculeSearch){
            $results = $vehiculeRepository-> findByMarqueAndModel($vehiculeSearch);
        }
        else{
            $results = $vehiculeRepository->findAll();
        }
